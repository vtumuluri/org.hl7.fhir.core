...
/**
 * 10_40 - conversion code ie "10_40" * AuditEvent - resource name ie "Patient" * dstu2 - low fhir version ie "dstu3" * r4 - high fhir version ie "r5" *
 */
class AuditEvent10_40Test extends BaseTest10_40 {

    protected final static String CLASS_NAME = "AuditEvent";
